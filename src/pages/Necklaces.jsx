      ...
      <div className="container">
        ...
        <header className="mb-16 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-serif text-accent">
            <WordReveal text="NECKLACES" delay={0.15} />
          </h1>

          <FadeUp delay={0.35}>
            <p className="text-muted mt-4 max-w-xl mx-auto text-sm md:text-base">
              Adorn yourself with our beautiful necklaces, perfect for every occasion.
            </p>
          </FadeUp>
        ...
        {necklaces.length > 0 ? (
          ...
          <FadeUp delay={0.3}>
            <p className="text-center text-muted py-20 font-sans">No necklaces found in the collection.</p>
          </FadeUp>
        )}
      </div>
    </div>
