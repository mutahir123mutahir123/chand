    ...
    <div className="pt-32 pb-20 bg-primary min-h-screen">
      <div className="container">
        <header className="mb-16 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-serif">NECKLACES</h1>
          <p className="text-muted mt-4 max-w-xl mx-auto">Adorn yourself with our beautiful necklaces, perfect for every occasion.</p>
        </header>
