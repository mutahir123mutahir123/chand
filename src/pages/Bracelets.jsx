    ...
    <div className="pt-32 pb-20 bg-primary min-h-screen">
      <div className="container">
        <header className="mb-16 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-serif">BRACELETS</h1>
          <p className="text-muted mt-4 max-w-xl mx-auto">Explore our stunning selection of bracelets, designed to adorn your wrist with grace.</p>
        </header>
