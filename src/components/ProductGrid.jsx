      ...
      <div className="container">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 space-y-4 md:space-y-0">
          <div>
            ...
            <Link to="/shop">
              <h2 className="text-4xl md:text-5xl font-serif hover:text-muted transition-colors">Featured Pieces</h2>
            </Link>
          </div>
          <Link to="/shop">
            <button className="text-[10px] tracking-[0.3em] font-sans uppercase border-b border-accent pb-1 hover:text-muted transition-colors cursor-pointer">
              View All Products
            </button>
          </Link>
        </div>
